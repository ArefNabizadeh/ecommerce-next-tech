...
class User(AbstractUser):
    phone_regex = RegexValidator(regex=r'^\+?1?\d{9,15}$', message=" شماره تلفن باید "
                                                                   "با 09 شروع شود و "
                                                                   "11 رقم باشد ")

    phone = models.CharField(max_length=11, validators=[phone_regex], blank=True,
                             null=True, verbose_name="شاره تلفن")
...
class Profile(models.Model):
    ...
    phone = models.CharField(max_length=11, blank=True, null=True, verbose_name="شملره "
                                                                                "تلفن",
                             validators=[
                                 RegexValidator(r'^09\d{9}$', 'شماره تلفن معتبر نیست')])
...
class Address(models.Model):
    ...
    unit = models.CharField(max_length=20, blank=True, null=True, verbose_name="واحد")
